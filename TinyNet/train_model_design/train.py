...
parser.add_argument('--mode', type=str, default='train', choices=['total', 'train', 'eval', 'test'],
...
def peak_based_eval(dataloader, factor, method, threshold_grid, subset=1250, tqdm_=False, thresh=1):
    acc_list = []
    f1_list = []
    fb_list = []
    prec_list = []
